...
//https://github.com/jadjoubran/angular-material-design-lite
//    angular.module("mdl").directive("mdlTextField", ["mdlConfig", function (l) {
//        return {
//            replace: true,
//            restrict: "E",
//            template: '<div class="mdl-textfield mdl-js-textfield" ng-class="ngClass"><input class="mdl-textfield__input" type="text" ng-readonly="readonly" ng-model="ngModel" /><label class="mdl-textfield__label">{{label}}</label></div>',
//            scope: {ngModel: "="},
//            link: function ($scope, el, $attrs) {//e, t, n
//
//                $scope.label = $attrs.label;
//                $scope.ngClass = {"mdl-textfield--floating-label": l.floating};
//            }
//        };
//    }]);
